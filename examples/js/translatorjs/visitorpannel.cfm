    ...
    success: function(response) {
        ...
        channels.forEach(d=>{
		   ...
		   // var firstTwoCharacters = customername.substring(0, 2).toUpperCase();
            htmlcontent = htmlcontent + "<div class=\"visibility\"><a onClick=\"init('" + d + "'," + i + ",'" + businessName + "')\"><span>" + firstTwoCharacters + "</span>" + titleCaseCustomer + "</a><br><div class=\"mainNotifications\">20</div></div>"; i++;
         })
