    ...
    <div class="mblmaxChat">
        <div class="rightChatSection">
            <div class="rightClassContents">
                ...
                <p class="chatDetails"><span class="owner" id="end-name">Akshay</span><span class="chatsText"> chats with </span><span class="customer" id="v-name">Deepika</span></p>
...
function initiatechat(){
    ...
    if (name.length >= 3) {
      ...
      //  document.getElementById("businesname1").textContent= name+" "+"chats with"+" "+ business
		...
		// bindChannel(currentUserID,$("form"))//here is loop hole
			...
			// 	  });
                $.ajax({
    url: "https://www.marketcentral.in/rest/virtualExpo/general/getChatHistory/"+cname+"/0",
    type: 'GET',
    dataType: 'json',
   ...
   //  alert(response)
    ...
    $.ajax({
    url: "https://www.marketcentral.in/rest/virtualExpo/general/getChat/0/"+currentUserID+"/0/"+stallId+"/3",
    type: 'GET',
    dataType: 'json',
    success: function(response) {
...
//	document.getElementById("chatLog").innerHTML = "";
    ...
    <!--- <script>
        $('.individualChatClose').click(function(){
            $('#chat-ui-room').css('display','none');
        })
    </script> --->
